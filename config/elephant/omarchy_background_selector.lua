...
function GetEntries()
  ...
  local theme_name_file = io.open(home .. "/.config/current/theme.name", "r")
  ...
  local dirs = {
    home .. "/.config/current/theme/backgrounds",
  }
  if theme_name then
    table.insert(dirs, home .. "/.config/backgrounds/" .. theme_name)
  end
